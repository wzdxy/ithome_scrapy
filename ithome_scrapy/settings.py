...
# Scrapy settings for ithome_scrapy project
#
...
BOT_NAME = 'ithome_scrapy'

SPIDER_MODULES = ['ithome_scrapy.spiders']
NEWSPIDER_MODULE = 'ithome_scrapy.spiders'
...
#    'ithome_scrapy.middlewares.MyCustomDownloaderMiddleware': 543,
#}
